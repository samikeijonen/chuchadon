...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="entry-inner">
		...
		<footer class="entry-footer">
			<?php chuchadon_post_terms( array( 'taxonomy' => 'jetpack-portfolio-type', 'text' => __( 'Portfolio in %s', 'chuchadon' ) ) ); ?>
			<?php chuchadon_post_terms( array( 'taxonomy' => 'jetpack-portfolio-tag', 'text' => __( 'Tagged %s', 'chuchadon' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
